/*! telemark-frontend - v0.0.0 - 2015-07-27 */!function(a) {
    a.flexslider = function(b, c) {
        ...
        var e = d.vars.namespace, f = window.navigator && window.navigator.msPointerEnabled && window.MSGesture, g = ("ontouchstart" in window || f || window.DocumentTouch && document instanceof DocumentTouch) && d.vars.touch, h = "click touchend MSPointerUp keyup", i = "", j, k = "vertical" === d.vars.direction, l = d.vars.reverse, m = d.vars.itemWidth > 0, n = "fade" === d.vars.animation, o = "" !== d.vars.asNavFor, p = {}, q = !0;
        a.data(b, "flexslider", d), p = {
            ...
            controlNav: {
                ...
                setupPaging: function() {
                    var b = "thumbnails" === d.vars.controlNav ? "control-thumbs" : "control-paging", c = 1, f, g;
            ...
            directionNav: {
                setup: function() {
                    var b = a('<ul class="' + e + 'direction-nav"><li class="' + e + 'nav-prev"><a class="' + e + 'prev" href="#">' + d.vars.prevText + '</a></li><li class="' + e + 'nav-next"><a class="' + e + 'next" href="#">' + d.vars.nextText + "</a></li></ul>");
                    ...
                    d.directionNav.bind(h, function(b) {
                        b.preventDefault();
                        var c;
                        ("" === i || i === b.type) && (c = d.getTarget(a(this).hasClass(e + "next") ? "next" : "prev"), 
            ...
            touch: function() {
                ...
                function e(a) {
                    ...
                    if (b) {
                        if (b.animatingTo === b.currentSlide && !t && null !== o) {
                            var c = l ? -o : o, d = b.getTarget(c > 0 ? "next" : "prev");
                ...
                var g, h, i, j, o, p, q, r, s, t = !1, u = 0, v = 0, w = 0;
                ...
                b.addEventListener("MSGestureEnd", e, !1)) : (q = function(a) {
                    ...
                    g = k ? v : u, h = k ? u : v, b.addEventListener("touchmove", r, !1), b.addEventListener("touchend", s, !1));
                }, r = function(a) {
                    u = a.touches[0].pageX, v = a.touches[0].pageY, o = k ? g - v : g - u, t = k ? Math.abs(o) < Math.abs(u - h) : Math.abs(o) < Math.abs(v - h);
                    var b = 500;
                    ...
                    if (b.removeEventListener("touchmove", r, !1), d.animatingTo === d.currentSlide && !t && null !== o) {
                        var c = l ? -o : o, e = d.getTarget(c > 0 ? "next" : "prev");
                    ...
                    b.removeEventListener("touchend", s, !1), g = null, h = null, o = null, i = null;
